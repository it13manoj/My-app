    ...
    <div style="width: 100%; background: #e5e5e5;padding: 15px 0;">
        <table style="width: 600px; margin: 0 auto; background-color: #ffffff">
            ...
            <tbody style="padding-left: 20px">
                ...
                <tr>
                    <td >
                       <p style="font-family: Calibri; margin-left: 20px">You are getting this email because you requested for password change</p>
						<p style="font-family: Calibri; margin-left: 20px">Please click the link to change password</p>
						<a style="font-family: Calibri; margin-left: 20px" href="{{url('cahngepassword/'.$id)}}">Change Password</a>
