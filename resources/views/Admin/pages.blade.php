...
<div class="content-wrapper">
 ...
 <!-------------Country Listing Start From Here--------------->
            <div class="card-body" id="listingdiv">
            	<button type="button" id="addbutton" class="btn btn-warning btn-fw" style="float:right;"> <span>+ Add Page</span></button>
            ...
            <div class="card-body" style="display: none;padding: 1.88rem" id="addeditdiv">
              ...
              <div class="row">
                <div class="col-8">
                  <div class="table-responsive">
                    <form class="forms-sample dataformtosubmit" method="POST" action="{{route('manager.pages.submit')}}">
                     @csrf
                    <div class="form-group">
                      <label for="exampleInputName1">Page Name</label>
                      <input class="form-control" required name="pagename" id="pagename" placeholder="Page Name" type="text">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" name="position" id="position" placeholder="Position" type="number">
