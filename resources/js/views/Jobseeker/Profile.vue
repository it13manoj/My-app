                     ...
                     <div>
                        <div class="tab style-2" role="tabpanel">
                           ...
                           <ul class="nav nav-tabs" role="tablist">
                              ...
                              <li class="pull-right"><router-link class="btn" to="/user_profile/personalinfo">Edit profile</router-link></li>
                           </ul>
        ...
        async beforeMount()
         {
            ...
            await this.getresumedetails(this.$session.get('id'));
         },
         created: function () {
         ...
         methods:{
            ...
            getresumedetails(page) {
                  var serff=this;
                  axios
                 .get('/../getUsersResumeDetails?access_token='+btoa(page))
                 .then(response => {
